...
- **Python 3.11+**
- **Azure OpenAI Resource** with a deployed chat model (e.g., `gpt-4o`, `gpt-4o-mini`)
...
```bash
git clone https://github.com/your-username/procure-price-agent.git
cd procure-price-agent
```
